...
import main.java.com.tasks.starts.Task22Start;
...
import static main.java.com.tasks.starts.Task24Start.startTask24Test;
...
class TaskSelect {
    static void selectTask(Integer number, Integer checkingType) {
        switch (number) {
            ...
            case 24: {
                if (checkingType.equals(1)) startTask24Test();
                else selectTask(24, 1);
                break;
            }
            default: {
